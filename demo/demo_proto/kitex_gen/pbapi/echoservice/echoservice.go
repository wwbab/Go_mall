...
type EchoResult struct {
	Success *pbapi.Respone
}

var EchoResult_Success_DEFAULT *pbapi.Respone

func (p *EchoResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(pbapi.Respone)
	}
...
func (p *EchoResult) GetSuccess() *pbapi.Respone {
	if !p.IsSetSuccess() {
...
func (p *kClient) Echo(ctx context.Context, Req *pbapi.Request) (r *pbapi.Respone, err error) {
	var _args EchoArgs
	_args.Req = Req
